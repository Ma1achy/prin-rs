...
pub fn write<W: Write>(
    ...
    let header = format!(
        "nx={} ny={} cx={} cy={} half={} body={}\n\
         ...
         r_coll_frac={} escape_rule={:?} closure_k={} stop_on_escape={} stop_on_event={} refine_flagged={} refine_threshold={} refine_eta_factor={} refine_max_passes={}\n\
         chart={} decode_path={}\n\
         chart_params={}\n\
         fields={}\n",
        ...
        cfg.r_coll_frac, cfg.escape_rule, cfg.closure_k, cfg.stop_on_escape, cfg.stop_on_event,
