...
fn main() {
    ...
    let ens = EnsembleCfg {
        n_extra: 7,
        jitter_frac: 0.5,
        jitter_scheme: prin_rs::ensemble::jitter::Scheme::Halton,
        seed: 0,
        t_max: 50.0,
        n_sync: 32,
        escape_every: 0,
        escape_confirm: true,
        escape_rule: prin_rs::outcome::EscapeRule::Closure(prin_rs::outcome::CLOSURE_TAU),
        closure_k: 1,
        stop_on_escape: false,
        dtau_mode: prin_rs::integrate::az::DtauMode::PerStepInterval,
        eta: 0.01,
        max_steps: 30_000,
        ref_policy: prin_rs::integrate::az::RefPolicy::PerCopy,
        lc_stable: true,
        r_coll_frac: 0.005,
        stop_on_event: true,
        ...
        ftle: None,
        ftle_dt: 1e-4,
        decode_path: prin_rs::decode::Path::DirectF64,
    };
