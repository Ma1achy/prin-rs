...
pub fn write<W: Write>(
    ...
    let header = format!(
        "nx={} ny={} cx={} cy={} half={} body={}\n\
         ...
         r_coll_frac={} r_esc_frac={} escape_all_bodies={} stop_on_event={} refine_flagged={} refine_threshold={} refine_eta_factor={} refine_max_passes={}\n\
         chart={} decode_path={}\n\
         chart_params={}\n\
         fields={}\n",
        ...
        cfg.r_coll_frac, cfg.r_esc_frac, cfg.escape_all_bodies, cfg.stop_on_event,
