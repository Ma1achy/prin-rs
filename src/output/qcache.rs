...
pub fn write<W: Write>(w: &mut W, c: &Cache, ens: &crate::ensemble::pixel::EnsembleCfg, tau: f64) -> io::Result<()> {
    ...
    let header = format!(
        "region={} chart={} body={} cx={:?} cy={:?} half={:?} levels={} n={} res={}\n\
         ...
         t_max={} n_sync={} eta={} n_copies={} jitter_frac={} r_coll_frac={} r_esc_frac={} escape_all_bodies={} \
...
sampled arbitrarily.\n\
        ...
        ens.t_max, ens.n_sync, ens.eta, ens.n_extra + 1, ens.jitter_frac, ens.r_coll_frac, ens.r_esc_frac, ens.escape_all_bodies,
        ens.jitter_scheme,
